...
public class abpSourceCodeDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        abpSourceCodeGlobalFeatureConfigurator.Configure();
        abpSourceCodeModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<abpSourceCodeDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<abpSourceCodeResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/abpSourceCode");

            options.DefaultResourceType = typeof(abpSourceCodeResource);
        ...
        {
            options.MapCodeNamespace("abpSourceCode", typeof(abpSourceCodeResource));
        });
    }
}

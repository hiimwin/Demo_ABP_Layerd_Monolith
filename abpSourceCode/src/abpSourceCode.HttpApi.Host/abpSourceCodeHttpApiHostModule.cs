...
[DependsOn(
    typeof(abpSourceCodeHttpApiModule),
    typeof(AbpStudioClientAspNetCoreModule),
    typeof(AbpAspNetCoreMvcUiLeptonXLiteThemeModule),
    typeof(AbpAutofacModule),
    typeof(AbpAspNetCoreMultiTenancyModule),
    typeof(abpSourceCodeApplicationModule),
    typeof(abpSourceCodeEntityFrameworkCoreModule),
    typeof(AbpAccountWebOpenIddictModule),
    typeof(AbpSwashbuckleModule),
    typeof(AbpAspNetCoreSerilogModule)
    )]
public class abpSourceCodeHttpApiHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("abpSourceCode");
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<abpSourceCodeDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}abpSourceCode.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<abpSourceCodeDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}abpSourceCode.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<abpSourceCodeApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}abpSourceCode.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<abpSourceCodeApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}abpSourceCode.Application"));
            });
        }
    }
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(abpSourceCodeApplicationModule).Assembly);
        });
    }
    ...
    private static void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
    {
        ...
        context.Services.AddAbpSwaggerGenWithOidc(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "abpSourceCode API", Version = "v1" });
    ...
    {
        context.Services.AddabpSourceCodeHealthChecks();
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "abpSourceCode API");

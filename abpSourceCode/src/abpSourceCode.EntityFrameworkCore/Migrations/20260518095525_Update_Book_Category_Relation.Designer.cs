...
namespace abpSourceCode.Migrations
{
    ...
    [Migration("20260518095525_Update_Book_Category_Relation")]
    partial class Update_Book_Category_Relation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("abpSourceCode.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("AvartalUrl")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("abpSourceCode.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abpSourceCode.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abpSourceCode.OrderItems.OrderItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("abpSourceCode.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abpSourceCode.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abpSourceCode.Users.UserInfor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppUserInfors", (string)null);
                });
            ...
            modelBuilder.Entity("abpSourceCode.Books.Book", b =>
                {
                    b.HasOne("abpSourceCode.Authors.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId");

                    b.HasOne("abpSourceCode.Categories.Category", "Category")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("abpSourceCode.OrderItems.OrderItem", b =>
                {
                    b.HasOne("abpSourceCode.Books.Book", "Book")
                        .WithMany("OrderItems")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("abpSourceCode.Orders.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("abpSourceCode.Payments.Payment", b =>
                {
                    b.HasOne("abpSourceCode.Orders.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("abpSourceCode.Payments.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("abpSourceCode.Users.UserInfor", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("abpSourceCode.Users.UserInfor", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
namespace abpSourceCode.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["abpSourceCode_App:RootUrl"]?.TrimEnd('/');
        ...
        {
            var swaggerRootUrl = configurationSection["abpSourceCode_Swagger:RootUrl"]?.TrimEnd('/');
